...
public class Pages extends base {
    ...
    public void Pratice_form()
    {
        ...
        wait1("//span[text()='Practice Form']");
        driver.findElement(By.xpath("//span[text()='Practice Form']")).click();
        driver.findElement(By.id("firstName")).sendKeys("Ankita");
        driver.findElement(By.id("lastName")).sendKeys("Ambast");
        driver.findElement(By.id("userEmail")).sendKeys("abc@gmail.com");

        wait1("(//label[@class='custom-control-label'])[1]");

        driver.findElement(By.xpath("(//label[@class='custom-control-label'])[1]")).click();
        driver.findElement(By.id("userNumber")).sendKeys("1234567890");
        driver.findElement(By.xpath("//input[@id='dateOfBirthInput']")).click();
//        dateField.sendKeys("1999-15-04");
       WebElement Webelementyear = driver.findElement(By.xpath("//select[@class='react-datepicker__year-select']"));
       WebElement WebElementmonth = driver.findElement(By.xpath("//select[@class='react-datepicker__month-select']"));
       base.select(Webelementyear,WebElementmonth,"August","2000");
       WebElement Webelementdate = driver.findElement(By.xpath("//div[@class='react-datepicker__day react-datepicker__day--016']"));
